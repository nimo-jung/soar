    ...
    <div className="tenant-page">
      <div className="page-header">
        ...
        <div className="tenant-actions-row">
          <Button buttonSize="default" icon="pi pi-sync" label={t('dashboard.actions.refresh')} outlined />
          <Button className="tenant-primary-action" buttonSize="default" icon="pi pi-plus" label={t('dashboard.actions.newPlaybook')} />
        </div>
      </div>
