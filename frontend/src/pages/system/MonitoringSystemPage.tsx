      ...
      >
        <div className="grid pt-2">
          ...
          <div className="col-12">
            ...
            <Dropdown value={draftSeverity} options={severityOptions} onChange={(event) => setDraftSeverity(String(event.value ?? ''))} className="w-full" />
          </div>
        ...
        <div className="col-12 xl:4">
          <Card title={t('monitoring.cards.engineHealth')} className="admin-card h-full monitoring-panel-card">
            <div className="flex align-items-center justify-content-between">
              ...
              <Tag value={overview.engineHealthy ? t('monitoring.engine.healthy') : t('monitoring.engine.unhealthy')} />
            </div>
          </Card>
        </div>
      </div>
