  ...
  return (
    <div className="tenant-page">
      <div className="tenant-page-header">
        ...
        <Button className="tenant-primary-action" buttonSize="default" label={t('collectors.registerBtn')} icon="pi pi-plus" onClick={() => setShowCreate(true)} />
      </div>
      ...
      <Dialog header={t('collectors.dialog.title')} visible={showCreate} style={{ width: '440px' }} onHide={() => setShowCreate(false)}>
        <div className="flex flex-column gap-3 pt-2">
          ...
          <Button buttonSize="default" label={t('common.register')} onClick={handleCreate} />
        </div>
      </Dialog>
    </div>
  );
